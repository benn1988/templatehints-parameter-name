 ...
 */
namespace DanStaver\TemplateHints\Plugin;
 ...
 */
class AddTemplateHintsParameterName
{
    /**
    ...
    /**
     * XPath of configuration of the parameter name
     */
    const XML_PATH_DEBUG_TEMPLATE_HINTS_PARAMETER_NAME = 'dev/debug/template_hints_parameter_name';
    ...
    public function afterCreate(
        ...
        if ($this->scopeConfig->getValue($this->debugHintsPath, ScopeInterface::SCOPE_STORE, $storeCode)
            ...
            $debugHintsParameterName = $this->scopeConfig->getValue(
                self::XML_PATH_DEBUG_TEMPLATE_HINTS_PARAMETER_NAME,
                ScopeInterface::SCOPE_STORE,
                $storeCode
            );
            $debugHintsParameterInUrl = $this->http->getParam($debugHintsParameterName);
